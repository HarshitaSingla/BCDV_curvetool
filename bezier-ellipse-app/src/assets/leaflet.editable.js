...
// ✅ Ensure global access for Angular dynamic loading
window.L = window.L || {};
window.L.Editable = window.L.Editable || L.Editable;

if (typeof window !== 'undefined' && window.L && L.Editable) {
  window.L.Editable = L.Editable;
}
